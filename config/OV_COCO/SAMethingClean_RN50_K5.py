...
#   - pseudo_box: "ow_labels/OW_COCO_FASTSAM_K5_conf010_filtered.json"  (was OW_COCO_R2.json)
#   - eval schedule: start=1, every=2  (set via CLI --eval_start_epoch 1 --eval_every_epoch 2;
#     these are argparse-only args and cannot live in the config file — see main.py lines 82-87)
#
# FastSAM JSON generated by tools/precompute_fastsam_pseudo_labels.py with:
#   conf=0.10, top-k=5, max-area-ratio=0.4, max-aspect-ratio=5.0, min-box-side=4.0
#
# All other hyperparameters (lr, batch_size, epochs, backbone, loss weights, augmentation)
...
pseudo_box = "ow_labels/OW_COCO_FASTSAM_K5_conf010_filtered.json"
in_channel=[512, 1024]
