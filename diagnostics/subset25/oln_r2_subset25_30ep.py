# Controlled 25%-subset run: OLN-25 arm.
# Identical to config/OV_COCO/OVDQUO_RN50.py EXCEPT:
#   - pseudo_box: "ow_labels/OW_COCO_R2_subset25.json"  (was OW_COCO_R2.json)
#
# Pair (same image IDs, same budget, weight semantics differ by design):
#   OLN-25   -> this file               -> ow_labels/OW_COCO_R2_subset25.json   (learned weights)
#   E-SAM-25 -> esam_uniform_subset25_30ep.py -> OW_COCO_ESAM_uniform_subset25.json (weight=1.0)
#
...
#   --output_dir outputs/oln_r2_subset25_30ep
...
pseudo_box = "ow_labels/OW_COCO_R2_subset25.json"
